...
const GREETINGS: Record<string, string> = {
  English: "Hi! Ask me anything about this monument, including its history, architecture, construction, or cultural importance.",
  Hindi: "नमस्ते! आप इस स्मारक के इतिहास, वास्तुकला, निर्माण या सांस्कृतिक महत्व के बारे में कुछ भी पूछ सकते हैं।",
  Gujarati: "નમસ્તે! તમે આ સ્મારકના ઇતિહાસ, સ્થાપત્ય, બાંધકામ અથવા સાંસ્કૃતિક મહત્વ વિશે કંઈપણ પૂછી શકો છો.",
  Tamil: "வணக்கம்! இந்த நினைவுச்சின்னத்தின் வரலாறு, கட்டிடக்கலை, கட்டுமானம் அல்லது கலாச்சார முக்கியத்துவம் பற்றி கேட்கலாம்.",
  Telugu: "నమస్కారం! ఈ స్మారక చిహ్నం చరిత్ర, నిర్మాణ శైలి, నిర్మాణం లేదా సాంస్కృతిక ప్రాముఖ్యత గురించి అడగవచ్చు.",
  Bengali: "নমস্কার! এই স্মৃতিস্তম্ভের ইতিহাস, স্থাপত্য, নির্মাণ বা সাংস্কৃতিক গুরুত্ব সম্পর্কে যেকোনো প্রশ্ন করতে পারেন।",
  Marathi: "नमस्कार! या स्मारकाचा इतिहास, वास्तुकला, बांधकाम किंवा सांस्कृतिक महत्त्व याबद्दल काहीही विचारू शकता.",
  Kannada: "ನಮಸ್ಕಾರ! ಈ ಸ್ಮಾರಕದ ಇತಿಹಾಸ, ವಾಸ್ತುಶಿಲ್ಪ, ನಿರ್ಮಾಣ ಅಥವಾ ಸಾಂಸ್ಕೃತಿಕ ಮಹತ್ವದ ಬಗ್ಗೆ ಕೇಳಬಹುದು.",
  Punjabi: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਤੁਸੀਂ ਇਸ ਸਮਾਰਕ ਦੇ ਇਤਿਹਾਸ, ਵਾਸਤੂਕਲਾ, ਨਿਰਮਾਣ ਜਾਂ ਸੱਭਿਆਚਾਰਕ ਮਹੱਤਵ ਬਾਰੇ ਕੁਝ ਵੀ ਪੁੱਛ ਸਕਦੇ ਹੋ.",
  French: "Bonjour ! Posez-moi vos questions sur l’histoire, l’architecture, la construction ou l’importance culturelle de ce monument.",
  Spanish: "¡Hola! Puedes preguntarme sobre la historia, arquitectura, construcción o importancia cultural de este monumento.",
  German: "Hallo! Fragen Sie mich gern nach der Geschichte, Architektur, Bauweise oder kulturellen Bedeutung dieses Denkmals.",
  Arabic: "مرحباً! يمكنك أن تسألني عن تاريخ هذا المعلم أو عمارته أو بنائه أو أهميته الثقافية.",
  Japanese: "こんにちは！この記念碑の歴史、建築、建設、文化的な重要性について何でも質問してください。",
  Korean: "안녕하세요! 이 기념물의 역사, 건축, 건설 또는 문화적 중요성에 대해 무엇이든 질문해 주세요.",
  Portuguese: "Olá! Pergunte sobre a história, arquitetura, construção ou importância cultural deste monumento.",
  Russian: "Здравствуйте! Вы можете спросить об истории, архитектуре, строительстве или культурном значении этого памятника.",
  Italian: "Ciao! Puoi chiedermi della storia, dell’architettura, della costruzione o dell’importanza culturale di questo monumento.",
};
...
export default function ChatWindow({
  ...
  const speakText = (text: string) => {
    ...
    const voice =
      voices.find(
        (item) => item.lang.toLowerCase() === bcp47.toLowerCase()
      ) ||
      voices.find((item) =>
        item.lang.toLowerCase().startsWith(bcp47.split("-")[0].toLowerCase())
      );
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/chat`, {
        ...
        body: JSON.stringify({
          ...
          monument_details: monumentDetails || null,
          question: text,
          language,
          history: apiHistory,
        }),
